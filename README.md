...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-05-28 15:51`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/236e74d4-78a5-4151-9592-4d00a8c3273c.git
$ cd 236e74d4-78a5-4151-9592-4d00a8c3273c
```
